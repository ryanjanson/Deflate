...
*/
#ifndef BOOST_DEFLATE_DETAIL_ADLER_HPP
#define BOOST_DEFLATE_DETAIL_ADLER_HPP
...
BOOST_DEFLATE_DECL
unsigned adler32(const unsigned char* buf, unsigned len, unsigned adler = 0U) noexcept;
...
#endif // BOOST_DEFLATE_DETAIL_ADLER_HPP
