...
#ifndef BOOST_DEFLATE_ERROR_HPP
#define BOOST_DEFLATE_ERROR_HPP
...
enum class error
{
    ...
    */
    ...
    incorrect_header_check,

    /// Bad gzip data checks
    incorrect_data_check,

    /// Bad gzip length checks
    incorrect_length_check,

    /// Unknown zlib method
    unknown_compression_method,

    /// Invalid zlib header window size
    invalid_window_size,

    /// Unknown zlib header flags set
    unknown_header_flags,

    /// Header CRC does not match with computed CRC
    header_crc_mismatch,
